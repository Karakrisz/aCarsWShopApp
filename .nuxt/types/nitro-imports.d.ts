declare global {
  const GqlAddItemToCart: typeof import('#gql-nitro')['GqlAddItemToCart']
  const GqlCartDetail: typeof import('#gql-nitro')['GqlCartDetail']
  const GqlCartItems: typeof import('#gql-nitro')['GqlCartItems']
  ...
  const GqlUpdateItemToCart: typeof import('#gql-nitro')['GqlUpdateItemToCart']
...
export { GqlAddItemToCart, GqlCartDetail, GqlCartItems, GqlProduct, GqlProducts, GqlRemoveCartItem, GqlUpdateItemToCart } from '#gql-nitro';
