...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHost, getRequestProtocol, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, setHeader, getHeader, getQuery as getQuery$1, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, joinRelativeURL } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/scule/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/errx/dist/index.js';
import { isVNode, toValue, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/vue/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { GraphQLClient } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/graphql-request/build/esm/index.js';
import nodemailer from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/nodemailer/lib/nodemailer.js';
import options from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/.nuxt/nuxt-mail/options.mjs';
import send$1 from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/.nuxt/nuxt-mail/send.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _p9IDVrzRBx = defineNitroPlugin(async (nitroApp) => {
...
const _QEid8wifCh = defineNitroPlugin(() => {
...
const _JAUxDp = defineEventHandler(async (e) => {
...
const _T4oz1l = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _aokadQ = defineEventHandler(async (e) => {
...
const _iuYzwU = defineEventHandler(async (e) => {
...
const _WxXVMf = defineEventHandler(async (e) => {
...
const _t2YF1k = defineEventHandler(async event => {
  try {
...
const _Q55VkI = lazyEventHandler(() => {
...
const _lazy_QczAwr = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_QczAwr, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _JAUxDp, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _T4oz1l, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _aokadQ, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _iuYzwU, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _WxXVMf, lazy: false, middleware: false, method: undefined },
  { route: '/mail/send', handler: _t2YF1k, lazy: false, middleware: false, method: "post" },
  { route: '/_ipx/**', handler: _Q55VkI, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_QczAwr, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/aCarsWShopApp/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
